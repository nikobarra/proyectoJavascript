function inicioTanda1(){//utilizamos jquery para incorporar elemntos al dom
...
function inicioTanda5(){
  $('#quest5').html ('<button id="1" class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Escondo mis problemas detras de una sonrisa, y ello me angustia.</button><button id="2" class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Estoy predispuesto para atender a los demas, me cuesta decir que NO.</button> <button id="3" class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Me influencian los cambios y algunas personas debido a mi sensibilidad.</button> <button id="4 "class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Me siento enojado, celoso y quiero revancha.</button>');
...
function inicioTanda6(){
  $('#quest6').html ('<button id="1" class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Tengo poca fe en mis capacidades.</button><button id="2" class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Me reprocho cosas, me siento culpable y me culpo a mi mismo.</button> <button id="3" class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Me siento abrumado por las responsabilidades y ello me deprime</button> <button id="4 "class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Me siento en el limite de mi resistencia, tengo angustia, desesperanza y sensacion de soledad.</button><button id="5" class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Estoy sufriendo los efectos de un duelo.</button><button id="6" class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >No es muy justo lo que me pasa y por eso estoy triste, amargo e irritable.</button> <button id="7" class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Tengo un exagerado sentido del deber, me exijo demasiado sin admitir cansancio.</button> <button id="8 "class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Me siento sucioy me averguenza mi apariencia</button>');
...
function inicioTanda7(){
  $('#quest7').html ('<button id="1" class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Tengo tendencia a ser posesivo y a sentirme ofendido con facilidad. Me cuesta separarme de mi familia.</button><button id="2" class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Soy un poco fanático, con ideas fijas que me cuesta cambiar, mi entusiasmo por hacer cosas me deja agotado.</button> <button id="3" class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >A veces me siento omnipotente, lo que me mantiene en tension. Suelo ser mandon y dominante.</button> <button id="4 "class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Soy demasiado rigido, crítico e intolerante con los demás.</button><button id="5" class="pregunta bg-pink-500 hover:bg-pink-300 text-white font-bold px-4 py-2 rounded text-base " >Soy demasiado rígido conmigo mismo, bueso la pertfección en todo.</button>');
